...
const Suggestion = () => {
  ...
  const [selectedMessage, setSelectedMessage] = useState(data?.data[0]);
  ...
  return (
    <>
      ...
      <div
        className="flex 
      bg-gray-50 text-white p-8 h-full"
      >
        {/* Left Side - User List */}
        ...
        {selectedMessage ? (
          ...
          <div className="w-2/3 bg-gray-100 p-6 rounded-lg flex justify-center items-center min-h-[150px]">
            <p className="text-black/50">Select a item!</p>
          </div>
        )}
      </div>
    </>
